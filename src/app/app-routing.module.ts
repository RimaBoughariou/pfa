...
export const routingComponents=[ProgrammeComponent,VolComponent,HotelComponent,CalendrierComponent,MenuComponent,OffreComponent,OffreCourtComponent,OffreLongComponent,ReservationComponent]
